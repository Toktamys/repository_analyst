...
class IssueAnalyst(BaseAnalyst):
    __MAX_DAYS_OFFSET = 14
    __query_params = {}
    ...
    def display_result(self):
        print("Result of issues analysis")
        text = f"Number of open issues - {self._number_open}\n"
        text += f"Number of closed  issues - {self._number_closed}\n"
        text += f"Number of 'old' issues - {self._number_old}\n"
        print(text, end="\n")
